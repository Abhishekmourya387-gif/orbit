...
export function RescueFlow({ token, onDashboard, onFocus, onCoach }: { token: string; onDashboard: () => void; onFocus: () => void; onCoach: () => void }) {
